...
import '../component/navbar.css';  // Update the path if necessary
...
function SpaceNavbar() {
  ...
  return (
    <Navbar expand="lg" bg="dark" variant="dark" expanded={navExpanded} onToggle={handleToggle} style={{ padding: '10px 25px 10px 25px' }}>
        <Navbar.Brand href="#home">
          <Link to="/home" className="d-flex align-items-center text-decoration-none">
            ...
            <span className="ms-2 text-white fw-bold" style={{ fontSize: '2rem', marginLeft: '20px'}}>SpaceOne</span>
          </Link>
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto text-center" style={{ fontSize: '1.15rem', fontWeight: '500px'}}>
            <Nav.Link as={Link} to="/home" className="text-white px-3 hover-effect">Home</Nav.Link>
            <Nav.Link as={Link} to="/apod" className="text-white px-3 hover-effect">Astronomy P-O-D</Nav.Link>
